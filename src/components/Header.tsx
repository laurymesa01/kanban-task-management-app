...
const Header = () => {
  ...
  return (
    <header className="h-(--header-height) pr-4 flex justify-between border-b border-lines-light dark:border-lines-dark">
      <div className='flex'>
        ...
        <h1 className='ml-4 self-center'>Platform Launch</h1>
      </div>
