...
const Sidebar = ({ isOpen, onHide }: { isOpen: boolean; onHide: () => void }) => {
  ...
  return (
    <aside className={`bg-white dark:bg-dark-grey flex flex-col shrink-0 h-full pb-8 border-r border-lines-light dark:border-lines-dark overflow-hidden transition-all duration-300 ${isOpen ? 'w-70' : 'w-0'}`}>
